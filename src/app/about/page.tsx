        ...
        <div style={{ background: "var(--surface)", padding: "40px", borderRadius: "var(--radius)", boxShadow: "var(--shadow-md)" }}>
          ...
          <ul style={{ listStyle: "none", padding: "0" }}>
            <li style={{ padding: "15px 0", borderBottom: "1px solid var(--border)", display: "flex", gap: "20px", alignItems: "center" }}>
              ...
              <div>
                <h4 style={{ fontSize: "1.2rem", margin: "0" }}>President Name</h4>
                <p style={{ color: "var(--text-muted)", margin: "0", fontSize: "0.9rem" }}>President, Nayka Samaj</p>
              </div>
            </li>
            <li style={{ padding: "15px 0", display: "flex", gap: "20px", alignItems: "center" }}>
              ...
              <div>
                <h4 style={{ fontSize: "1.2rem", margin: "0" }}>Secretary Name</h4>
                <p style={{ color: "var(--text-muted)", margin: "0", fontSize: "0.9rem" }}>General Secretary, Nayka Samaj</p>
              </div>
            </li>
          </ul>
        </div>
